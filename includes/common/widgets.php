		...
		<?php else : ?>
			...
			<div class="bbp-logged-in">
				<span class="bbp-greeting">
					...
					Hello, <?php echo get_user_meta( bbp_get_current_user_id(), 'first_name', true ); ?>!
				</span>
				<a href="<?php bbp_user_profile_url( bbp_get_current_user_id() ); ?>" class="button">My Profile</a>
